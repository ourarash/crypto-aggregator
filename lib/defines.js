...
Globals = {
   ...
   * In the example below, using g_tickers['BTC/USD'],
   * we can aggregate the price of BTC in USD
   * by converting the non-USD member of the pair of
   * g_tickers[market][exchange]['pairs'][index].ticker to USD
   *         g_tickers = {
   *           'BTC/USD' : {
   *             'binance': {
